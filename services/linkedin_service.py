...
# LinkedIn REST API version for Documents and Posts (use supported version)
LINKEDIN_REST_VERSION = "202410"
...
def post_to_linkedin_with_document(
    ...
    try:
        with open(local_file_path, "rb") as f:
            file_bytes = f.read()
        content_type = _get_content_type_for_file(local_file_path)
        upload_headers = {
            "Authorization": f"Bearer {access_token}",
